 ...
 * @author Wojtek
 */
public class SpriteSheetList extends Sprite {
    ArrayList<Texture> list = new ArrayList<>();

    private final float xTiles;
    private final float yTiles;

    public static SpriteSheetList create(ArrayList<Texture> list, int width, int height, int xStart, int yStart, SpriteBase spriteBase) {
        return new SpriteSheetList(list, width, height, xStart, yStart, spriteBase, false);
    }

    public static SpriteSheetList createSetScale(ArrayList<Texture> list, int width, int height, int xStart, int yStart, SpriteBase spriteBase) {
        return new SpriteSheetList(list, width, height, xStart, yStart, spriteBase, true);
    }

    protected SpriteSheetList(ArrayList<Texture> list, int width, int height, int xStart, int yStart, SpriteBase spriteBase, boolean scale) {
        super("soc", 0,0,0,0,spriteBase);
        if (scale) {

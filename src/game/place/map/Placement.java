...
public class Placement {
    ...
    public static final short CENTER = 0, TOP_LEFT = 1, TOP = 2, TOP_RIGHT = 3,
            LEFT = 4, RIGHT = 5, BOTTOM_LEFT = 6, BOTTOM = 7, BOTTOM_RIGHT = 8;
    ...
    private void calculateNear(int[] nearAreas, int area, int xArea, int yArea) {
        ...
        if (yArea - 1 >= 0) {
            ...
            nearAreas[TOP] = area - map.getXAreas();
        ...
        if (yArea + 1 < map.getYAreas()) {
            ...
            nearAreas[BOTTOM] = area + map.getXAreas();

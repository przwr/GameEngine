...
//                System.out.println("Darkness...");
    ...
    public static void initializeRenderer() {
        ...
        shads[0] = (GameObject emitter1, Figure shade1, Point[] points1) -> {
            shade1.getOwner().renderShadow((emitter1.getLight().getWidth() / 2) - (emitter1.getX()), (emitter1.getLight().getHeight() / 2) - (emitter1.getY()) + displayHeight - emitter1.getLight().getHeight(), shade1);
        };
        shads[1] = (GameObject emitter1, Figure shade1, Point[] points1) -> {
            shade1.getOwner().renderShadowLit((emitter1.getLight().getWidth() / 2) - (emitter1.getX()), (emitter1.getLight().getHeight() / 2) - (emitter1.getY()) + displayHeight - emitter1.getLight().getHeight(), shade1.getShadowColor(), shade1);
        };
        ...
        shads[4] = (GameObject emitter1, Figure shad, Point[] points1) -> {
            shade.getOwner().renderShadowLit((emitter1.getLight().getWidth() / 2) - (emitter1.getX()), (emitter1.getLight().getHeight() / 2) - (emitter1.getY()) + displayHeight - emitter1.getLight().getHeight(), shade.getShadowColor(), shade, points1[0].getX(), points1[0].getY());
        };
        shads[5] = (GameObject emitter1, Figure shad, Point[] points1) -> {
            shade.getOwner().renderShadow((emitter1.getLight().getWidth() / 2) - (emitter1.getX()), (emitter1.getLight().getHeight() / 2) - (emitter1.getY()) + displayHeight - emitter1.getLight().getHeight(), shade, points1[0].getX(), points1[0].getY());
        };

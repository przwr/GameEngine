...
public class LangPL extends Language {
    ...
    public LangPL() {
        ...
        OnlineGame = "Gra sieciowa";
        RunServer = "Uruchom serwer";
        JoinServer = "Połącz z serwerem";
        ServerIP = "IP Serwera: ";
        Port = "Port";
        ...
        Disconnected = "Połączenie z serwerem zostało zerwane!";
        Options = "Opcje";
        End = "Zakończ";
        Quit = "Wyjdź";
        Number_Of_Players = "Liczba graczy: ";
        SplitScreen = "Dzielenie ekranu: ";
        Vertical = "Pionowo";
        Horizontal = "Poziomo";
        Brigthness = "Jasność: ";
        Volume = "Głośność: ";
        ...
        Actions[0] = "Góra (menu)";
        Actions[1] = "Dół (menu)";
        Actions[2] = "Zatwierdź (menu)";
        Actions[3] = "Cofnij (menu) / wznów";
        Actions[4] = "Góra";
        Actions[5] = "Dół";
        Actions[6] = "Lewo";
        Actions[7] = "Prawo";

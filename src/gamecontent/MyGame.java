...
public class MyGame extends Game {
    ...
    public void startGame() {
        ...
        if (playersCount == 1) {
            players[0].initializeSetPosition(4, 10, 56, 104, place, 256, 256);
            players[0].setCamera(new PlayersCamera(players[0], 2, 2, 0)); // 2 i 2 to tryb SS
        } else if (playersCount == 2) {
            players[0].initializeSetPosition(4, 10, 56, 104, place, 256, 256);
            players[1].initializeSetPosition(4, 10, 56, 104, place, 512, 1024);
            ...
            players[0].initializeSetPosition(4, 10, 56, 104, place, 256, 256);
            players[1].initializeSetPosition(4, 10, 56, 104, place, 512, 1024);
            players[2].initializeSetPosition(4, 10, 56, 104, place, 1024, 512);
            if (Settings.horizontalSplitScreen) {
                players[0].setCamera(new PlayersCamera(players[0], 2, 4, 0));
            } else {
                players[0].setCamera(new PlayersCamera(players[0], 4, 2, 0));
            ...
            players[1].initializeSetPosition(4, 10, 56, 104, place, 512, 1024);
            players[2].initializeSetPosition(4, 10, 56, 104, place, 1024, 512);
            players[3].initializeSetPosition(4, 10, 56, 104, place, 1024, 1024);
    ...
    private void addPlayerOffline(int player) {
        if (player < 4 && place.playersCount < 4) {
            players[player].initializeSetPosition(4, 10, 56, 104, place, player * 256, player * 265);
    ...
    public void runClient() {
        ...
        players[0].initialize(4, 10, 56, 104, place);
        players[0].setCamera(new PlayersCamera(players[0], 2, 2, 0)); // 2 i 2 to tryb SS

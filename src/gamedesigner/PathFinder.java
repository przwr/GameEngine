...
public class PathFinder extends javax.swing.JFrame {
    ...
    private final AbstractFileGetter cel;
    private final String ext;

    public PathFinder(AbstractFileGetter cel, File dir, FileNameExtensionFilter filter, int mode) {   // mode : 0 - wczytanie obrazka, 1 - "wyjście" zapisywanych plików, 2 - wczytanie zapisanej tekstury
        initComponents();
        this.cel = cel;
